...
return [
    ...
    'saas' => [
        'hospitals' => [
            ...
            'show_success' => 'Hospital loaded.',
            'created' => 'Hospital tenant created.',
            'not_found' => 'Hospital not found.',
            'validation_failed' => 'Invalid hospital create request.',
            'provision_failed' => 'Hospital provisioning failed.',
            'packages_success' => 'Hospital package catalog loaded.',
            'usage_success' => 'Hospital usage loaded.',
            'usage_failed' => 'Failed to measure hospital usage.',
            'purge_success' => 'Hospital data purge completed.',
            'purge_failed' => 'Hospital data purge failed.',
            'purge_validation_failed' => 'Invalid purge confirmation input.',
            'destroy_success' => 'Hospital fully destroyed.',
            'destroy_failed' => 'Hospital destroy failed.',
