...
return [
    ...
    'saas' => [
        'hospitals' => [
            ...
            'show_success' => '병원 정보를 조회했습니다.',
            'created' => '병원 테넌트를 생성했습니다.',
            'not_found' => '병원을 찾을 수 없습니다.',
            'validation_failed' => '병원 생성 요청이 올바르지 않습니다.',
            'provision_failed' => '병원 프로비저닝에 실패했습니다.',
            'packages_success' => '병원 패키지 카탈로그를 조회했습니다.',
            'usage_success' => '병원 용량 정보를 조회했습니다.',
            'usage_failed' => '병원 용량 측정에 실패했습니다.',
            'purge_success' => '병원 데이터 정리가 완료되었습니다.',
            'purge_failed' => '병원 데이터 정리에 실패했습니다.',
            'purge_validation_failed' => '데이터 정리 확인 입력값이 올바르지 않습니다.',
            'destroy_success' => '병원이 완전히 삭제되었습니다.',
            'destroy_failed' => '병원 삭제에 실패했습니다.',
