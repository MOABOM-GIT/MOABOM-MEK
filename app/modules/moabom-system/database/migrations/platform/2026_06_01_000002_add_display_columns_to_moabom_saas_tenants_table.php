...
/**
 * moabom_saas_tenants 에 병원 표시용 메타 컬럼 추가 (display_name·region·address).
 *
    ...
    public function up(): void
    {
        ...
        Schema::table('moabom_saas_tenants', function (Blueprint $table): void {
            if (! Schema::hasColumn('moabom_saas_tenants', 'display_name')) {
                $table->string('display_name', 200)->nullable()->after('host')->comment('병원 표시명 (general.json site_name 동기화)');
            }
