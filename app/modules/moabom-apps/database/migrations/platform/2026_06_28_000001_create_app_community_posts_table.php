...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::connection($this->connection)->create('moabom_app_community_posts', function (Blueprint $table): void {
    ...
    {
        Schema::connection($this->connection)->dropIfExists('moabom_app_community_posts');
    }
};
