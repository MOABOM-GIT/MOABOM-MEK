...
const logger = ((window as any).G7Core?.createLogger?.('Template:moabom-admin_basic')) ?? {
    log: (...args: unknown[]) => console.log('[Template:moabom-admin_basic]', ...args),
    warn: (...args: unknown[]) => console.warn('[Template:moabom-admin_basic]', ...args),
    error: (...args: unknown[]) => console.error('[Template:moabom-admin_basic]', ...args),
};
