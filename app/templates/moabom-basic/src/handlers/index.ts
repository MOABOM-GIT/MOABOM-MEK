 ...
 * // 또는 풀네임으로
 * {
 *   "handler": "moabom.addSelectedItemIfComplete",
 *   "params": { ... }
 * }
 */
export const handlers = {
  // 상품 옵션
  'moabom.addSelectedItemIfComplete': addSelectedItemIfCompleteHandler,
  'moabom.updateSelectedItemQuantity': updateSelectedItemQuantityHandler,

  // 다중 통화
  'moabom.getDisplayPrice': getDisplayPriceHandler,
  'moabom.formatCurrency': formatCurrencyHandler,
  'moabom.getCurrencySymbol': getCurrencySymbol,
  'moabom.loadPreferredCurrency': loadPreferredCurrencyHandler,
  'moabom.savePreferredCurrency': savePreferredCurrencyHandler,
 ...
 */
export type MoabomThemeHandlers = typeof handlers;
