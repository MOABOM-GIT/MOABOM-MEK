  ...
  const renderButtons = () => (
    <Div className="flex items-center justify-center gap-2">
      ...
      {!hasAvatar && (
        <Label
          htmlFor={inputId}
          className={`inline-flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 text-secondary rounded-lg text-sm font-bold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer ${
      ...
      {hasAvatar && (
        <>
          ...
          {showDeleteButton && (
            <Button
              type="button"
              className="inline-flex items-center gap-2 px-4 py-2 border border-red-300 dark:border-red-600 text-red-600 dark:text-red-400 rounded-lg text-sm font-bold hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          {showUploadConfirm && pendingFile && (
            <Div className="w-full p-3 bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800 rounded-lg">
              ...
              <Div className="grid grid-cols-2 gap-2">
                <Button
                  type="button"
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-sm font-bold transition-colors disabled:opacity-50"
                ...
                <Button
                  type="button"
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-secondary rounded-md text-sm font-bold hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
          ...
          {showDeleteConfirm && (
            <Div className="w-full p-3 bg-red-50 dark:bg-red-950/50 border border-red-200 dark:border-red-800 rounded-lg">
              ...
              <Div className="grid grid-cols-2 gap-2">
                <Button
                  type="button"
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md text-sm font-bold transition-colors disabled:opacity-50"
