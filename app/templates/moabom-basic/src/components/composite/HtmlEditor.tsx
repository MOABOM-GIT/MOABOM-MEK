          ...
          {isHtml && !readOnly && (
            <Button
              ...
              className={`px-3 py-1.5 text-xs font-bold rounded-lg focus:outline-none focus:ring-2 ${
                previewMode
                  ? 'text-secondary bg-gray-200 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 hover:bg-gray-300 dark:hover:bg-gray-500 focus:ring-gray-400 dark:focus:ring-gray-500'
      ...
      {!previewMode && (
        <Textarea
          ...
          className={`block w-full rounded-lg border px-3 py-2 text-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-1 disabled:opacity-50 disabled:cursor-not-allowed ${
            isHtml
              ? 'font-mono bg-white dark:bg-gray-800 border-blue-300 dark:border-blue-600 text-primary focus:border-blue-500 focus:ring-blue-500'
              : 'bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-primary focus:border-blue-500 focus:ring-blue-500'
          }`}
        />
      )}
      ...
      {previewMode && (
        <Div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 min-h-[400px]">
          <HtmlContent
            ...
            isHtml={true}
            className={contentClassName || 'prose dark:prose-invert max-w-none text-primary'}
