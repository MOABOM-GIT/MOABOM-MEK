    ...
    >
      ...
      >
        ...
        <Div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-800">
          ...
          <Button
            onClick={onClose}
            className="p-2 text-gray-500 hover:text-secondary dark:hover:text-gray-200"
            aria-label="메뉴 닫기"
          >
          ...
          <Div className="p-4 border-b border-gray-200 dark:border-gray-800">
            <Div className="flex gap-2">
              <Button
                ...
                className="flex-1 py-2 text-center text-sm font-bold text-white bg-gray-900 dark:bg-white dark:text-gray-900 rounded-lg cursor-pointer"
              >
                {t('auth.login')}
              </Button>
              <Button
                onClick={() => { onClose(); navigate('/register'); }}
                className="flex-1 py-2 text-center text-sm font-bold text-primary border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer"
              >
                {t('auth.register')}
              </Button>
            </Div>
          ...
          <Ul className="space-y-1">
            ...
            <Li>
              <Button
                ...
                className="flex items-center gap-3 px-3 py-2 w-full text-left text-primary hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg cursor-pointer"
              >
            ...
            {/* 게시판 메뉴 */}
            <Li className="px-3 py-2 text-xs font-bold text-muted uppercase tracking-wider">
              {t('nav.boards')}
            </Li>
            {boards.map((board) => (
              <Li key={board.id}>
