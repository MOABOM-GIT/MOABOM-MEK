        ...
        <Div className={`relative flex items-center ${showButton ? 'gap-2' : ''}`}>
          ...
          <Div className="relative flex-1">
            ...
            <Div className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
              <Icon name={IconName.Search} className="w-5 h-5 text-faint" />
            </Div>
            ...
            <Input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-primary text-sm"
            />
          </Div>
          ...
          {showButton && (
            <Button
              type="submit"
              className="px-4 py-2 bg-gray-800 dark:bg-gray-600 text-white rounded-lg hover:bg-gray-900 dark:hover:bg-gray-500 transition-colors text-sm font-bold cursor-pointer h-[42px]"
            >
              {t('common.search')}
            </Button>
          )}
          ...
          {suggestions.map((suggestion) => (
            ...
            >
              <Div className="flex items-center gap-2">
                <Icon name={IconName.Search} className="w-4 h-4 text-faint" />
                <Span className="text-sm text-secondary">{suggestion.text}</Span>
              </Div>
            </Div>
          ))}
        </Div>
