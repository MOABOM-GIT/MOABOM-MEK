...
export const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  const confirmVariantClassMap: Record<'primary' | 'secondary' | 'danger' | 'ghost', string> = {
    ...
    secondary: 'bg-gray-200 dark:bg-gray-700 text-primary hover:bg-gray-300 dark:hover:bg-gray-600',
    danger: 'bg-red-600 text-white hover:bg-red-700',
    ghost: 'bg-transparent text-secondary hover:bg-gray-100 dark:hover:bg-gray-700',
  };
    ...
    >
      ...
      <Div className="flex justify-end gap-3 mt-6">
        ...
        <Button
          ...
          disabled={isLoading}
          className="px-4 py-2 bg-white dark:bg-gray-800 text-secondary border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
        >
