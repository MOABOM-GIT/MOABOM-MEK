        ...
        {(title || icon || showCloseButton) && (
          <Div className="flex items-center justify-between p-4">
            {(title || icon) && (
              <Div
                id="modal-title"
                className="flex items-center gap-3 text-lg font-bold text-heading"
              >
            ...
            {showCloseButton && (
              <Button
                onClick={onClose}
                className="ml-auto text-faint hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none"
