...
export const FileList: React.FC<FileListProps> = ({
  ...
  return (
    <Div className="p-3">
          ...
          <Div className="grid grid-cols-2 @sm:grid-cols-3 @md:grid-cols-4 @lg:grid-cols-5 gap-3">
            ...
            {canAddMore && (
              <Div
                ...
                onClick={onAddClick}
              >
                <I className="fa-solid fa-plus text-2xl text-faint mb-1" />
                <Span className="text-xs text-muted">{t('common.add')}</Span>
              </Div>
            )}
          </Div>
        </SortableContext>
      ...
      {/* 하단 정보 */}
      <Div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center text-xs text-muted">
