  ...
  return (
    <Div className={`flex items-center gap-2 ${className}`}>
      ...
      <Button
        ...
        onClick={handleClick}
        disabled={disabled}
        className="px-4 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md text-sm font-bold text-secondary hover:bg-gray-200 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {buttonText}
      </Button>
