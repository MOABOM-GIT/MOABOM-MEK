...
export const Input = forwardRef<HTMLInputElement, InputProps>(({
  ...
  /** `Textarea`와 동일: 비어 있으면 재사용 필드, `bg-*` 또는 이미 `glass-sm`+`moa-field`면 그대로, 그 외는 표면+유틸 병합 */
  const resolvedClassName = useMemo(() => {
    if (isBareDecorativeType) {
  ...
  }, [className, isBareDecorativeType]);
