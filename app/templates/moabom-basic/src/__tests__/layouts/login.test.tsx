  ...
  components: [
    {
      ...
      children: [
          ...
          children: [
            {
              type: 'basic',
              name: 'Label',
              props: { className: 'block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3' },
              text: '이메일',
            },
            {
              type: 'basic',
        ...
        // 제출 버튼
        {
          ...
          props: {
            type: 'submit',
            className: 'w-full py-3 mt-12 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg font-bold hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2',
            disabled: '{{_global.isLoggingIn}}',
